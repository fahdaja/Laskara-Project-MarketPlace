...
export default function ServiceCard({
  ...
  return (
    <Link
      ...
      aria-label={`Lihat detail ${gig.title}`}
      className="block h-full rounded-3xl focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-100"
    >
